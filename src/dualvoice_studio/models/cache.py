...
from dualvoice_studio.models.project import RenderPlan
from dualvoice_studio.utils.hashing import build_chunk_hash, hash_file, hash_payload
...
class CachePaths:
    ...
    def build(cls, output_dir: Path, project_name: str) -> "CachePaths":
        ...
        project_root = output_dir / f"{safe_name}_dualvoice"
        return cls(
